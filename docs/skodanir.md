...
Ef færa þarf skoðanir áður en komið er inn í tímabil skoðunargluggans, þá verður að færa aukaskoðun (sjá kafla 3.3.4) sem birtist í fellivalmynd undir `Aðrar skoðanir`.
:::
